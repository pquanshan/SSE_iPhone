...
@interface HSStockSystemViewController ()<HSPHttpRequestDelegate>{
    NSArray* titleArr;
...
@implementation HSStockSystemViewController
...
//    c2.tabBarItem.badgeValue = @"99+";
    ...
    self.tabBar.tintColor = [HSColor getColorByColorNavigation];
